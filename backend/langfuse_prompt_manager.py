...
DEFAULT_PROMPTS = {
    ...
    "planner_prompt": (
        ...
        "2. MANDATORY RULE: If the request asks for information after 2024, or words like 'news', 'latest', 'today', 'current', 'recent', 'weather', 'stock price', or live facts, you MUST append the exact string [NEEDS_WEB_SEARCH] at the end of your plan.\n"
    ...
    "worker_general_prompt": (
        ...
        "2. Knowledge Cutoff & Live Search: If the user asks about events, releases, or news after 2024, or if Context is missing and you lack verified facts, DO NOT apologize about your cutoff or guess. Output ONLY: [NEEDS_WEB_SEARCH: <concise search query>] so real-time information is retrieved for you.\n"
    ...
    "validator_prompt": (
        ...
        "1. Cutoff Apology: Does the draft contain knowledge cutoff apologies (e.g., 'as of my 2024 cutoff', 'up to mid-2024') instead of answering? If so, FAIL with 'FAIL: CUTOFF_DETECTED'.\n"
        "2. Grounding: Did the draft hallucinate facts contrary to or unsupported by the Context?\n"
        "3. Completeness: Did the draft answer what the user asked?\n\n"
