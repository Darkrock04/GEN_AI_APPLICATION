...
if not st.session_state.messages:
    ...
    <div class="cap-grid">
        ...
        <div class="cap-card">
            <div class="cap-icon">🔒</div>
            <div class="cap-title">Enterprise Security</div>
            <div class="cap-desc">
        ...
        <div class="cap-card">
            ...
            <div class="cap-title">Customizable Controls</div>
            <div class="cap-desc">
                Temperature, Top P, format, language — tune every parameter in real-time.
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
